...
<!-- <div class="crumb_warp">
	...
	<i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 后台管理首页
</div> -->
<!--面包屑导航 结束-->
...
<div class="result_wrap">
    ...
    <div class="result_content">
        <ul>
            <li>
                <label>官方交流网站：</label><span><a href="https://www.baidu.com/">百度一下，你就知道</a></span>
            </li>
            <li>
                <label>官方交流QQ群：</label><span>888888888</span>
            </li>
        </ul>
    </div>
</div>
