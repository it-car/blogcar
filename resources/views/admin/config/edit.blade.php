            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>类型：</th>
                        <td>
                            <input type="radio" value="input" name="field_type" onclick="showTr()" @if($field->field_type=='input') checked @endif>input　
                            <input type="radio" value="textarea" name="field_type" onclick="showTr()" @if($field->field_type=='textarea') checked @endif>textarea　
                            <input type="radio" value="radio" name="field_type" onclick="showTr()" @if($field->field_type=='radio') checked @endif>radio
                        </td>
                    </tr>
                    <tr class="field_vlue">
                        <th>类型值：</th>
                    ...
                    <tr>
                        <th>说明：</th>
                        <td>
                            <textarea name="conf_tips" style="resize: none;">{{$field->conf_tips}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
